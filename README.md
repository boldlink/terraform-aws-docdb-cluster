...
| <a name="input_change_stream_log_retention_duration"></a> [change\_stream\_log\_retention\_duration](#input\_change\_stream\_log\_retention\_duration) | (Optional) Change stream log retention duration. Allowed values: 3600-604800 | `number` | `10800` | no |
...
| <a name="input_profiler"></a> [profiler](#input\_profiler) | (Optional) Enable profiler ? Allowed values: enabled, disabled | `string` | `"disabled"` | no |
| <a name="input_profiler_threshold_ms"></a> [profiler\_threshold\_ms](#input\_profiler\_threshold\_ms) | (Optional) set profiler threshold; value in milliseconds: Allowed values: 50-2147483646 | `number` | `100` | no |
...
| <a name="input_tls"></a> [tls](#input\_tls) | (Optional) Enable tls ? Allowed values: enabled, disabled | `string` | `"enabled"` | no |
| <a name="input_to_port"></a> [to\_port](#input\_to\_port) | (Required) End port (or ICMP code if protocol is 'icmp') | `number` | `0` | no |
| <a name="input_ttl_monitor"></a> [ttl\_monitor](#input\_ttl\_monitor) | (Optional) Enable tll\_monitor ? Allowed values: enabled, disabled | `string` | `"enabled"` | no |
